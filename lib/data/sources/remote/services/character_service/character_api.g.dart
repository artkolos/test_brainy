...
class _CharacterApi implements CharacterApi {
  _CharacterApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CharacterPageDto> getCharacters({
    ...
    final _options = _setStreamType<CharacterPageDto>(
    ...
    late CharacterPageDto _value;
    try {
      _value = CharacterPageDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<CharacterDto> getCharacterById(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CharacterDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/character/${id}',
